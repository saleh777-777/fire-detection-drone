...
Mission script (project1(test).py): connects to PX4 over MAVSDK, arms and takes off the drone,
uploads a lawnmower-pattern survey mission over the fire area,
and runs a detection loop in parallel that checks for fire readings at each telemetry tick.
